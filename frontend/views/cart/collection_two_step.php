...
<section class="login-wrap">
    <div class="col-sm-4"></div>
        <div class="col-sm-4 middle-content">
            ...
            <h2>Confirm your collection time</h2>
            <?php $form = ActiveForm::begin(['id' => 'collection_two_step']); ?>

            <?=Html::tag('p','Collection time',['class'=>'lotitle'])?>
            ...
            <?=Html::hiddenInput('type','collection_two_step')?>
